...
if (!function_exists('modularity_customevents_render_blade_view')) {
    function modularity_customevents_render_blade_view($view, $data = [], $compress = true)
    {
        $init = new ComponentLibraryInit([
            MODULARITY_CUSTOMEVENTS_MODULE_VIEW_PATH
        ]);
