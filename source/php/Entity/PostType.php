...
namespace ModularityCustomEvents\Entity;
...
class PostType
{
    ...
    public function registerPostType()
    {
        $labels = array(
            ...
            'add_new'             => sprintf(__('Add new %s', 'modularity-customevents'), $this->nameSingular),
            'add_new_item'        => sprintf(__('Add new %s', 'modularity-customevents'), $this->nameSingular),
            'edit_item'           => sprintf(__('Edit %s', 'modularity-customevents'), $this->nameSingular),
            'new_item'            => sprintf(__('New %s', 'modularity-customevents'), $this->nameSingular),
            'view_item'           => sprintf(__('View %s', 'modularity-customevents'), $this->nameSingular),
            'search_items'        => sprintf(__('Search %s', 'modularity-customevents'), $this->namePlural),
            'not_found'           => sprintf(__('No %s found', 'modularity-customevents'), $this->namePlural),
            'not_found_in_trash'  => sprintf(__('No %s found in trash', 'modularity-customevents'), $this->namePlural),
            'parent_item_colon'   => sprintf(__('Parent %s:', 'modularity-customevents'), $this->nameSingular),
        ...
        register_taxonomy( $this->slug . "_category", array( $this->slug ), [
            "labels" => ["name" => __('Event Kategori', 'modularity-customevents')],
            'public' => true,
            "hierarchical" => true,
            'show_ui' => true, 
